...
export default function Home() {
    ...
    return (
        <div className="min-h-screen relative bg-gradient-to-b from-backgroundDark via-[80%] to-backgroundLight">
            ...
            <footer className="fixed bottom-0 opacity-100 bg-gradient-to-b to-backgroundDark from-backgroundLight/20 left-0 right-0 z-10 pb-8 pt-4 px-4 flex justify-center space-x-4" style={{ paddingBottom: 'calc(1.8rem + env(safe-area-inset-bottom, 24px))' }}>
